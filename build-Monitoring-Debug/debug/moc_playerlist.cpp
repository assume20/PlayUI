...
QT_MOC_LITERAL(1, 11, 6), // "toItem"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 16) // "QTreeWidgetItem*"

    },
    "Playerlist\0toItem\0\0QTreeWidgetItem*"
};
...
void Playerlist::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->toItem((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Playerlist::*_t)(QTreeWidgetItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Playerlist::toItem)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Playerlist::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_Playerlist.data,
...
// SIGNAL 0
void Playerlist::toItem(QTreeWidgetItem * _t1)
{
