...
QT_MOC_LITERAL(1, 7, 16), // "getImageFinished"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5) // "image"

    },
    "Thread\0getImageFinished\0\0image"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getImageFinished((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Thread::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::getImageFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread::getImageFinished(QImage _t1)
{
